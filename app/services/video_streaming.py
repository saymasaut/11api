...
async def get_stream_url(url: str, quality: str = "default", api_base_url: str = "http://localhost:8000") -> dict:
    ...
    if ("pornhub.com" in parsed_url.netloc.lower() or 
        ...
        "lesbianporn8.net" in parsed_url.netloc.lower()):
