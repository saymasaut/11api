...
EXPLORE_SOURCES = [
    ...
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.google.com/search?q={query}+site:ulluwebseries.one",
    ...
    ExploreSourceResponse(
        ...
        nickname="Motherless",
        favicon="https://motherless.com/favicon.ico",
        accentColor="#212121",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://motherless.com/term/videos/{query}",
        sourceId="motherless",
        disable=False,
        pageSize=60,
    ),
