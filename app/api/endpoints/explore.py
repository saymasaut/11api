...
EXPLORE_SOURCES = [
    ...
    ExploreSourceResponse(
        ...
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://www.thekamababa.com/?s={query}",
        sourceId="kamababa",
        disable=False,
        pageSize=30,
    ),
    ...
    ExploreSourceResponse(
        baseUrl="https://uncutmaza.com/",
        nickname="UncutMaza",
        favicon="https://uncutmaza.com/favicon.ico",
        accentColor="#C2185B",
        category="porn",
        isVerified=False,
        hasCategories=True,
        searchUrlTemplate="https://uncutmaza.com/?s={query}",
        sourceId="uncutmaza",
        disable=False,
        pageSize=30,
    ),
